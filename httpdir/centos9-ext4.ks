...
# Installation source
url --url http://centos-stream.mirror.wearetriple.com/9-stream/BaseOS/x86_64/os/
repo --name=AppStream --baseurl=http://centos-stream.mirror.wearetriple.com/9-stream/AppStream/x86_64/os/
...
# We are building a RHEL based kvm
redhat-release
redhat-release-eula
-fedora-release
-fedora-repos
